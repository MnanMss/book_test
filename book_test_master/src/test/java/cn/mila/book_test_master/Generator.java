...
public class Generator {
    ...
    private static final String USERNAME = "mila";

    /**
     * 项目信息
     */
    private static final String PROJECT_PATH = System.getProperty("user.dir") + "/book_test_master";
    private static final String JAVA_PATH = "/src/main/java";
    private static final String RESOURCE_PATH = "/src/main/resources";
    private static final String BASE_PACKAGE = "cn.mila.book_test_master";
    ...
    private static final String DATABASE_NAME = "book_test";
